...
class FairDbUser : public FairDbRelationalParSet<FairDbUser>
{
  ...
  public :
    ...
    static TObjArray* GetByFullName(string FullName, UInt_t rid=0);
    static TObjArray* GetByEmail(string Email, UInt_t rid=0);
    static TObjArray* GetByAddress(string Address, UInt_t rid=0);
    static TObjArray* GetByStatus(Int_t Status, UInt_t rid=0);
    static TObjArray* GetByRole(Int_t Role, UInt_t rid=0);
